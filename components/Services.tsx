...
const services = [
  ...
  { name: 'Mobile Auto Diagnostics', image: '/images/engine-diagnostics-montgomerytx.jpg', alt: 'Mobile auto diagnostics Montgomery County', bullets: ['Advanced on-site diagnostics', 'Identify issues before they worsen', 'Quick and accurate results'] },
  ...
  { name: 'Mobil One Oil Changes', image: '/images/mobile-oil-change-woodlands.jpg', alt: 'Mobile oil change The Woodlands TX', bullets: ['High-quality oil and filters', 'Maintain engine health and performance in Montgomery County', 'Quick, on-site service'] },
