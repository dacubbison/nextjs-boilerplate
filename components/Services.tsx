...
const services = [
  ...
  { name: 'Mobil One Oil Changes', image: '/images/mobile-oil-change-woodlands.jpg', alt: 'Mobile oil change The Woodlands TX', bullets: ['High-quality oil and filters', 'Maintain engine health and performance', 'Quick, on-site service'] },
