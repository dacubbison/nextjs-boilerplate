...
export default function QuoteForm() {
  return (
    <section className="quote-form-section bg-navy-900 text-white py-10 px-5 text-center">
      <h2 className="text-2xl font-bold mb-6">Share Your Shop Quote - I'll Often Beat It by Up to 50%! (Mobile Mechanic Near Me in The Woodlands, Kingwood, Montgomery County TX)</h2>
