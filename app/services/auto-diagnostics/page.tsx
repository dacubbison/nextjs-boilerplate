        ...
        <div className="modal-overlay" aria-modal="true" role="dialog">
          <div className="book-modal-content">
            ...
            <form onSubmit={handleBookSubmit} className="book-form">
              ...
              <select id="make" value={make} onChange={(e) => setMake(e.target.value)} required aria-label="Select make for auto diagnostics near me">
              ...
              <button type="submit" className="modal-btn submit-btn" aria-label="Submit and book auto diagnostics near me">Submit & Book</button>
