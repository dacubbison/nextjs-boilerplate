  ...
  return (
    <main>
      <section className="service-hero">
        <h1>AC Diagnostic and Repair Near Me in Kingwood TX</h1>
        <p>Mobile AC inspections, leak detection, and recharges in Montgomery County TX with fair and upfront pricing.</p>
        <Image src="/images/ac-recharge.jpg" alt="Mechanic diagnosing car AC in Kingwood TX" width={800} height={400} loading="lazy" />
      </section>

      <section className="service-details">
        <h2>Our AC Diagnostic Services</h2>
        <p>Fix cooling issues fast with on-site diagnostics and repairs.</p>
        <ul>
          <li>AC system inspections</li>
          <li>Leak detection and recharge</li>
          <li>Efficient cooling restorations</li>
        </ul>
      </section>

      <section className="faqs">
        <h2>FAQs about AC Diagnostics in Kingwood TX</h2>
        <details>
          <summary>Why is my AC not cooling?</summary>
          <p>Common causes like low refrigerant—diagnosed quickly.</p>
        </details>
        <details>
          <summary>What is the diagnostic cost?</summary>
      ...
      <Script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Mobile AC diagnostic and repair services with fair pricing."
        })}
      </Script>
    </main>
  );
