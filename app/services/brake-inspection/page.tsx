  ...
  return (
    <main>
      <section className="service-hero">
        <h1>Mobile Brake Inspection Near Me in The Woodlands TX</h1>
        <p>Safety-focused brake checks and repairs on-site in Montgomery County TX with fair and upfront pricing.</p>
        <Image src="/images/brake-service.jpg" alt="Mechanic inspecting brakes in The Woodlands TX" width={800} height={400} loading="lazy" />
      </section>

      <section className="service-details">
        <h2>Our Brake Inspection Services</h2>
        <p>Full system checks for pads, rotors, and fluids to ensure safe driving.</p>
        <ul>
          <li>Pad and rotor inspections</li>
          <li>Fluid and line checks</li>
          <li>On-site brake repairs</li>
        </ul>
      </section>

      <section className="faqs">
        <h2>FAQs about Brake Inspections in The Woodlands TX</h2>
        <details>
          <summary>When should I get brakes inspected?</summary>
          <p>Every 6 months or if you hear squeaking.</p>
        </details>
        <details>
          <summary>What is the inspection cost?</summary>
          <p>$80 with clear repair quotes.</p>
        </details>
      </section>
      ...
      <Script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Mobile brake inspection services with fair pricing."
        })}
      </Script>
    </main>
  );
